...
"VAR additional_tests.txt"
)

declare -a longopts=(
"--number-nonblank test_case_cat.txt"
"--number test_case_cat.txt"
"--squeeze-blank test_case_cat.txt"
)
